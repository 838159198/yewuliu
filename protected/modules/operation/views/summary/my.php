<div class="container-fluid">
    <div class="page-header sp-title">
        <h1 class="text-center">我的工作总结列表<small></small></h1>
    </div>
</div>
<div class="container-fluid">
...
//关于分页器这个array，具体还有很多属性，可参考CLinkPager的API
        ...
        'columns' => array(
            ...
            array(
                'header'=>"操作",
                'value'=>'($data->status==0)?"<a class=\"label label-warning\" href=\'javascript:summaryProjectImport(".$data->id.")\'><span class=\"glyphicon glyphicon-plus\" aria-hidden=\"true\"></span> 添加项目</a>":""',
                'htmlOptions'=>array("style"=>"text-align:center;width:100px;"),
                'type'=>'raw',
                'filter'=>false,
            ),
