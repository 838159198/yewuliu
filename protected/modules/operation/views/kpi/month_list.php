<div class="container-fluid">
    <div class="page-header sp-title">
        <h1 class="text-center">月度kpi考核列表<small></small></h1>
    </div>
</div>
<div class="container-fluid">
    <a class="btn btn-primary" href="<?php echo Yii::app()->createUrl("operation/kpi/createMonth");?>"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> 创建月度KPI考核</a>
</div>
<div class="container-fluid">
...
//关于分页器这个array，具体还有很多属性，可参考CLinkPager的API
        ...
        'columns' => array(
            ...
            array(
                'name'=>'title',
                'value'=>'"<a href=\'/operation/kpi/monthDetail?id=".$data->id."\'><span ></span> $data->title</a>"',
                'type'=>'raw',
            ),
            array(
                'name'=>'mid',
            ...
            /*array(
                ...
                'htmlOptions'=>array("style"=>"text-align:center;width:150px;"),
                'type'=>'html',
                'filter'=>CHtml::listData(SummaryWeek::model()->listDataStatus,'key','value'),
                //'filter'=>false,
            ),*/
            array(
                'header'=>"操作",
                'value'=>'"<a class=\"label label-warning\" href=\'/operation/kpi/monthDetail?id=".$data->id."\'><span class=\"glyphicon glyphicon-zoom-in\" aria-hidden=\"true\"></span> 详情</a>"',
