...
<div class="container">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6" id = 'testLog'>
            <input type="hidden" id="testProjeNum"  name ="testProjeNum" value = '<?php echo $testProjectCountNum;?>'>
            ...
            <?php $i=1;foreach($testProjectArray as $pro_k => $pro_v):?>
                <div class="rowBottom" id="<?php echo $i;?>">
                    <div class="input-group">
                        <input class="form-control" name="OperationTest[project][]" id="OperationTest_project" type="text" value="<?php echo $pro_v;?>">
