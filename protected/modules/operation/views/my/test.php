<div class="container-fluid">
    <div class="page-header sp-title">
        <h1 class="text-center">我测试的业务流<small></small></h1>
    </div>
</div>
<!-- <div class="container-fluid">
...
<div class="container-fluid">
    <?php $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'id' => 'default-grid',
        'dataProvider' =>$model->retest($data),
...
//关于分页器这个array，具体还有很多属性，可参考CLinkPager的API
        ...
        'columns' => array(
            ...
            array(
                'name'=>'create_mid',
                'value'=>'empty($data->create_mid)?"--":$data->manage_create->name',
                'htmlOptions'=>array("style"=>"text-align:center;width:80px;"),
                'filter'=>CHtml::listData(OperationPost::model()->listDataCreate,'id','name'),
            ),
            array(
                'name'=>'receive_mid',
                'value'=>'empty($data->manage_receive)?"--":$data->manage_receive->name',
                'htmlOptions'=>array("style"=>"text-align:center;width:80px;"),
                'filter'=>CHtml::listData(OperationPost::model()->listDataReceive,'id','name'),
            ),
            array(
                'name'=>'owner_mid',
                'value'=>'empty($data->manage_owner)?"--":$data->manage_owner->name',
                'htmlOptions'=>array("style"=>"text-align:center;width:80px;"),
                'filter'=>CHtml::listData(OperationPost::model()->listDataOwner,'id','name'),
            ),
            array(
                'name'=>'owner_uid',
                'value'=>'empty($data->owner_uid)? "--":$data->manage_develop->name',
                'htmlOptions'=>array("style"=>"text-align:center;width:80px;"),
                'filter'=>CHtml::listData(OperationPost::model()->listDataDevelop,'id','name'),
            ),
            ...
            array(
                'name'=>'cur_status',
                'value'=>'$data->xcur_status',
                'htmlOptions'=>array("style"=>"text-align:center;width:100px;"),
                'type'=>'html',
                'filter'=>CHtml::listData(OperationPost::model()->listDatacurStatus,'key','value'),
            ),
            array(
                'header'=>"版本号",
                'value'=>'($data->status==2 && $data->version_number=="")?"<a class=\"label label-warning\" href=\'javascript:createVersionTips(".$data->id.")\'><span class=\"glyphicon glyphicon-list-alt\" aria-hidden=\"true\"></span> 生成</a>":""',
                'htmlOptions'=>array("style"=>"text-align:center;width:70px;"),
                'type'=>'raw',
                'filter'=>false,
            ),
