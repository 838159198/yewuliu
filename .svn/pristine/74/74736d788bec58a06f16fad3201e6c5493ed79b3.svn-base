<div class="container-fluid">
    <div class="page-header sp-title">
        <h1 class="text-center">我参与的业务流<small></small></h1>
    </div>
</div>
...
//关于分页器这个array，具体还有很多属性，可参考CLinkPager的API
        ...
        'columns' => array(
            ...
            array(
                'header'=>"操作",
                'value'=>'($data->status==3)?"<a class=\"label label-warning\" href=\'javascript:addOperationTips(".$data->id.")\'><span class=\"glyphicon glyphicon-list-alt\" aria-hidden=\"true\"></span> 生成</a>":""',
                'htmlOptions'=>array("style"=>"text-align:center;width:70px;"),
                'type'=>'raw',
                'filter'=>false,
            ),
