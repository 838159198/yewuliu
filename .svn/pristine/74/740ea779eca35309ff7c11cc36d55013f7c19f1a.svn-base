<div class="container-fluid">
    <div class="page-header sp-title">
        <h1 class="text-center">我的业务池<small></small></h1>
    </div>
</div>
<div class="container-fluid">
...
//关于分页器这个array，具体还有很多属性，可参考CLinkPager的API
        ...
        'columns' => array(
            ...
            array(
                'header'=>"版本号",
                'value'=>'($data->status==2 && $data->version_number=="")?"<a class=\"label label-warning\" href=\'javascript:createVersionTips(".$data->id.")\' target=\"_blank\"><span class=\"glyphicon glyphicon-list-alt\" aria-hidden=\"true\"></span> 生成</a>":""',
                'htmlOptions'=>array("style"=>"text-align:center;width:70px;"),
                'type'=>'raw',
                'filter'=>false,
            ),
