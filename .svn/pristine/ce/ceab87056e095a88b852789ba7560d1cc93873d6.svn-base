<div class="container-fluid">
    <div class="page-header sp-title">
        <h1 class="text-center">工作计划总结列表（周）<small></small></h1>
    </div>
</div>
<div class="container-fluid">
    <a class="btn btn-primary" href="<?php echo Yii::app()->createUrl("operation/summary/createWeek");?>"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> 创建周总结</a>
</div>
<div class="container-fluid">
...
//关于分页器这个array，具体还有很多属性，可参考CLinkPager的API
        ...
        'columns' => array(
            ...
            array(
                'header'=>"操作",
                'value'=>'"<a class=\"label label-warning\" href=\'/operation/summary/weekDetail?id=".$data->id."\'><span class=\"glyphicon glyphicon-zoom-in\" aria-hidden=\"true\"></span> 详情</a>"',
