                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <?php foreach($manageData as $_manageData):
                                                        if($_manageData['department'] == $departmentData_c['id']):?>
                                                            <button type="button" class="btn btn-default" onclick="receiveUser('<?php echo $_manageData['name']?>')" data-dismiss="modal"><?php echo $_manageData['name']?></button>
...
<script type="text/javascript">
    function receiveUser(name)
    {
        $("#<?php echo $keyname;?>").val(name);
        //$("#<?php echo $keyname;?>").attr("value",name);//填充内容
